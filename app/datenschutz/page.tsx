...
export default function Datenschutz() { 
    return(
        <div className="my-12">
            ...
            <h2 className="hightlight underline my-5"id="einleitung-ueberblick">Einleitung und Überblick</h2>
            <p>Wir haben diese Datenschutzerklärung (Fassung 18.01.2024-312704709) verfasst, um Ihnen gemäß der Vorgaben der <a href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=312704709#d1e2269-1-1" target="_blank" rel="noopener">Datenschutz-Grundverordnung (EU) 2016/679</a> und anwendbaren nationalen Gesetzen zu erklären, welche personenbezogenen Daten (kurz Daten) wir als Verantwortliche &#8211; und die von uns beauftragten Auftragsverarbeiter (z. B. Provider) &#8211; verarbeiten, zukünftig verarbeiten werden und welche rechtmäßigen Möglichkeiten Sie haben. Die verwendeten Begriffe sind geschlechtsneutral zu verstehen.<br />
            ...
            <h2 className="hightlight underline my-5"id="anwendungsbereich">Anwendungsbereich</h2>
            ...
            <h2 className="hightlight underline my-5"id="rechtsgrundlagen">Rechtsgrundlagen</h2>
            ...
            <h2 className="hightlight underline my-5"id="kontaktdaten-verantwortliche">Kontaktdaten des Verantwortlichen</h2>
            ...
            <b>Florian Thönelt<br />
            Lutherstr. 71<br />
            30171 Hannover</b>
            <br />
            <b>Vertretungsberechtigt: Florian Thönelt</b>
            <br />
            E-Mail: <a href="mailto:kontakt@florianthoenelt.de">florian@thoenelt.dev</a>
            <br />
            Impressum: <Link href="/impressum/" className="underline">Zum Impressum</Link>
            </p>
            <h2 className="hightlight underline my-5"id="speicherdauer">Speicherdauer</h2>
            ...
            <h2 className="hightlight underline my-5"id="rechte-dsgvo">Rechte laut Datenschutz-Grundverordnung</h2>
            ...
            <p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche in sonst einer Weise verletzt worden sind, können Sie sich bei der Aufsichtsbehörde beschweren. Diese ist für Österreich die Datenschutzbehörde, deren Website Sie unter <a href="https://www.dsb.gv.at/?tid=312704709" target="_blank" rel="noopener">https://www.dsb.gv.at/</a> finden. In Deutschland gibt es für jedes Bundesland einen Datenschutzbeauftragten. Für nähere Informationen können Sie sich an die <a href="https://www.bfdi.bund.de/DE/Home/home_node.html" target="_blank" rel="noopener">Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI)</a> wenden. Für unser Unternehmen ist die folgende lokale Datenschutzbehörde zuständig:</p>
            <h2 className="hightlight underline my-5"id="niedersachsen-datenschutzbehoerde">Niedersachsen Datenschutzbehörde</h2>
            <p>
            <strong>Landesbeauftragte für Datenschutz:</strong> Barbara Thiel<br />
            <strong>Adresse: </strong>Prinzenstraße 5, 30159 Hannover<br />
            <strong>Telefonnr.:</strong> 05 11/120-45 00<br />
            <strong>E-Mail-Adresse:</strong> <a href="mailto:poststelle@lfd.niedersachsen.de" target="_blank" rel="follow noopener">poststelle@lfd.niedersachsen.de</a>
            <br />
            <strong>Website: </strong>
            <a href="https://lfd.niedersachsen.de/startseite/?tid=312704709" target="_blank" rel="noopener">https://lfd.niedersachsen.de/startseite/</a>
            </p>
            <h2 className="hightlight underline my-5"id="datenuebertragung-drittlaender">Datenübertragung in Drittländer</h2>
            ...
            <h2 className="hightlight underline my-5"id="sicherheit-datenverarbeitung">Sicherheit der Datenverarbeitung</h2>
            ...
            <h2 className="hightlight underline my-5"id="tls-verschluesselung-https">TLS-Verschlüsselung mit https</h2>
            ...
            <p>Damit haben wir eine zusätzliche Sicherheitsschicht eingeführt und erfüllen den Datenschutz durch Technikgestaltung (<a href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=312704709" target="_blank" rel="noopener">Artikel 25 Absatz 1 DSGVO</a>). Durch den Einsatz von TLS (Transport Layer Security), einem Verschlüsselungsprotokoll zur sicheren Datenübertragung im Internet, können wir den Schutz vertraulicher Daten sicherstellen.<br />
            ...
            <h2 className="hightlight underline my-5"id="cookies">Cookies</h2>
            <table>
            <tbody>
            <tr>
            <td>
            ...
            <strong>Wert:</strong> GA1.2.1326744211.152312704709-9<br />
            ...
            <p>
            <a href="https://support.google.com/chrome/answer/95647?tid=312704709" target="_blank" rel="noopener noreferrer">Chrome: Cookies in Chrome löschen, aktivieren und verwalten</a>
            </p>
            <p>
            <a href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=312704709" target="_blank" rel="noopener noreferrer">Safari: Verwalten von Cookies und Websitedaten mit Safari</a>
            </p>
            <p>
            <a href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=312704709" target="_blank" rel="noopener noreferrer">Firefox: Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a>
            </p>
            <p>
            <a href="https://support.microsoft.com/de-de/windows/l%C3%B6schen-und-verwalten-von-cookies-168dab11-0753-043d-7c16-ede5947fc64d?tid=312704709">Internet Explorer: Löschen und Verwalten von Cookies</a>
            </p>
            <p>
            <a href="https://support.microsoft.com/de-de/microsoft-edge/cookies-in-microsoft-edge-l%C3%B6schen-63947406-40ac-c3b8-57b9-2a946a29ae09?tid=312704709">Microsoft Edge: Löschen und Verwalten von Cookies</a>
            </p>
            ...
            <h2 className="hightlight underline my-5"id="webdesign-einleitung">Webdesign Einleitung</h2>
            <table >
            <tbody>
            <tr>
            <td>
            ...
            <h2 className="hightlight underline my-5" id="font-awesome-datenschutzerklaerung">Font Awesome Datenschutzerklärung</h2>
            <table>
            <tbody>
            <tr>
            <td>
            ...
            <h2 className="hightlight underline my-5"id="schlusswort">Schlusswort</h2>
            ...
            <p className="mt-1">Quelle: Erstellt mit dem <a href="https://www.adsimple.de/datenschutz-generator/" className="underline" title="Datenschutz Generator von AdSimple für Deutschland">Datenschutz Generator</a> von AdSimple</p>
