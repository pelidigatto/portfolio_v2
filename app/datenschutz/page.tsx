...
export const metadata: Metadata = {
  title: "Datenschutz | thoenelt.dev",
  description: "Datenschutzerklärung von thoenelt.dev",
  robots: "noindex, nofollow",
};
export default function Datenschutz() {
  return (
    <div className="my-12">
      <h1 className="hightlight underline my-5">Datenschutzerklärung</h1>
      <h2 className="hightlight underline my-5">Inhaltsverzeichnis</h2>
      <ul>
        <li>
        ...
        <li>
          <a href="#webdesign-einleitung">Webdesign Einleitung</a>
        </li>
        <li>
          <a href="#schlusswort">Schlusswort</a>
        </li>
      </ul>
      <h2 className="hightlight underline my-5" id="einleitung-ueberblick">
        Einleitung und Überblick
      </h2>
      <p>
        Wir haben diese Datenschutzerklärung (Fassung 18.01.2024-312704709)
        verfasst, um Ihnen gemäß der Vorgaben der{" "}
        <a
          href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=312704709#d1e2269-1-1"
          target="_blank"
          rel="noopener"
        >
      ...
      <h2 className="hightlight underline my-5" id="anwendungsbereich">
        Anwendungsbereich
      </h2>
      <p>
      ...
      <h2 className="hightlight underline my-5" id="rechtsgrundlagen">
        Rechtsgrundlagen
      </h2>
      <p>
      ...
      <h2
        className="hightlight underline my-5"
      ...
      <p>
        ...
        <br />
        <b>Vertretungsberechtigt: Florian Thönelt</b>
        <br />
        E-Mail:{" "}
        <a href="mailto:kontakt@florianthoenelt.de">florian@thoenelt.dev</a>
        <br />
        Impressum:{" "}
      ...
      <h2 className="hightlight underline my-5" id="speicherdauer">
        Speicherdauer
      </h2>
      <p>
      ...
      <h2 className="hightlight underline my-5" id="rechte-dsgvo">
      ...
      <p>
        ...
        <a
          href="https://www.dsb.gv.at/?tid=312704709"
          target="_blank"
          rel="noopener"
        >
          https://www.dsb.gv.at/
      ...
      <h2
        className="hightlight underline my-5"
        id="niedersachsen-datenschutzbehoerde"
      >
        Niedersachsen Datenschutzbehörde
      </h2>
      <p>
        <strong>Landesbeauftragte für Datenschutz:</strong> Barbara Thiel
        <br />
        <strong>Adresse: </strong>Prinzenstraße 5, 30159 Hannover
        <br />
        <strong>Telefonnr.:</strong> 05 11/120-45 00
        <br />
        ...
        <a
          href="https://lfd.niedersachsen.de/startseite/?tid=312704709"
          target="_blank"
          rel="noopener"
        >
      ...
      <h2 className="hightlight underline my-5" id="tls-verschluesselung-https">
      ...
      <p>
        ...
        <a
          href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=312704709"
          target="_blank"
          rel="noopener"
        >
      ...
      <h2 className="hightlight underline my-5" id="cookies">
        Cookies
      </h2>
      <table>
        <tbody>
      ...
      <p>
        ...
        <br />
        <strong>Wert:</strong> GA1.2.1326744211.152312704709-9
        <br />
      ...
      <p>
        <a
          href="https://support.google.com/chrome/answer/95647?tid=312704709"
          target="_blank"
      ...
      <p>
        <a
          href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=312704709"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <p>
        <a
          href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=312704709"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <p>
        <a href="https://support.microsoft.com/de-de/windows/l%C3%B6schen-und-verwalten-von-cookies-168dab11-0753-043d-7c16-ede5947fc64d?tid=312704709">
          Internet Explorer: Löschen und Verwalten von Cookies
        </a>
      </p>
      <p>
        <a href="https://support.microsoft.com/de-de/microsoft-edge/cookies-in-microsoft-edge-l%C3%B6schen-63947406-40ac-c3b8-57b9-2a946a29ae09?tid=312704709">
      ...
      <h2 className="hightlight underline my-5" id="webdesign-einleitung">
        ...
        <tbody>
          <tr>
            <td>
              ...
              <br />
              &#x1f4d3; Verarbeitete Daten: etwa IP-Adresse und und welche
              Icon-Dateien geladen werden
              <br />
              Mehr Details dazu finden Sie weiter unten in dieser
              Datenschutzerklärung.
              <br />
              &#x1f4c5; Speicherdauer: Dateien in identifizierbarer Form werden
              wenige Wochen gespeichert
              <br />
              &#x2696;&#xfe0f; Rechtsgrundlagen: Art. 6 Abs. 1 lit. a DSGVO
              (Einwilligung), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte
              Interessen)
      ...
      <p>
        Icons spielen für Websites eine immer wichtigere Rolle. Font Awesome ist
        eine Web-Schriftart, die speziell für Webdesigner und Webentwickler
        ...
        Icons oder Schriftarten auf Ihre Website zu laden. Dafür mussten wir nur
        eine kleine Code-Zeile in unsere Website einbinden.
      </p>
      ...
      <p>
        ...
        werden. So können Sie sich auf unserer Website besser orientieren und
        die Inhalte leichter erfassen. Mit den Icons kann man sogar manchmal
        ganze Wörter ersetzen und Platz sparen. Da ist besonders praktisch, wenn
        wir Inhalte speziell für Smartphones optimieren.  Diese Icons werden
        statt als Bild als HMTL-Code eingefügt. Dadurch können wir die Icons mit
        CSS genauso bearbeiten, wie wir wollen. Gleichzeitig verbessern wir mit
        Font Awesome auch unsere Ladegeschwindigkeit, weil es sich nur um
        HTML-Elemente handelt und nicht um Icon-Bilder. All diese Vorteile
        helfen uns, die Website für Sie noch übersichtlicher, frischer und
        schneller zu machen.
      </p>
      <h3>Welche Daten werden von Font Awesome gespeichert?</h3>
      <p>
        Zum Laden von Icons und Symbolen wird das Font Awesome Content Delivery
        Network (CDN) verwendet. CDNs sind Netzwerke von Servern, die weltweit
        verteilt sind und es möglich machen, schnell Dateien aus der Nähe zu
        laden. So werden auch, sobald Sie eine unserer Seiten aufrufen, die
        entsprechenden Icons von Font Awesome bereitgestellt.
      </p>
      <p>
        Damit die Web-Schriftarten geladen werden können, muss Ihr Browser eine
        Verbindung zu den Servern des Unternehmens Fonticons, Inc. herstellen.
        Dabei wird Ihre IP-Adresse erkannt. Font Awesome sammelt auch Daten
        darüber, welche Icon-Dateien wann heruntergeladen werden. Weiters werden
        auch technische Daten wie etwa Ihre Browser-Version, Bildschirmauflösung
        oder der Zeitpunkt der ausgerufenen Seite übertragen.
      </p>
      ...
      <p>
        Falls Ihr Browser Web-Schriftarten nicht zulässt, wird automatisch eine
        Standardschrift Ihres PCs verwendet. Nach derzeitigem Stand unserer
      ...
      <h3>Rechtsgrundlage</h3>
      <p>
        Wenn Sie eingewilligt haben, dass Font Awesome eingesetzt werden darf,
        ...
        bei der Erfassung durch Font Awesome vorkommen kann, dar.
      </p>
      <p>
        Von unserer Seite besteht zudem ein berechtigtes Interesse, Font Awesome
        ...
        Wir setzen Font Awesome gleichwohl nur ein, soweit Sie eine Einwilligung
        erteilt haben.
      </p>
      <p>
        Wir weisen darauf hin, dass nach Meinung des Europäischen Gerichtshofs
        derzeit kein angemessenes Schutzniveau für den Datentransfer in die USA
        besteht. Die Datenverarbeitung geschieht im Wesentlichen durch Font
        Awesome. Dies kann dazu führen, dass gegebenenfalls Daten nicht
        ...
        Daten nehmen. Es kann ferner vorkommen, dass diese Daten mit Daten aus
        möglichen anderen Diensten von Font Awesome, bei denen Sie ein
      ...
      <h2 className="hightlight underline my-5" id="schlusswort">
        Schlusswort
      </h2>
      <p>
